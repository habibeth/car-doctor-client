...
const BookingRow = ({ booking, handleDelete, handleBookingConfirm }) => {
    const { _id, customerName, img, date, price, service, status } = booking;
    return (
        <tr>
            <th>
            ...
            <th>
                {
                    ...
                    :
                    <button onClick={()=>handleBookingConfirm(_id)} className="btn btn-ghost btn-xs">Please confirm item </button>
                }
            </th>
        </tr>
    );
